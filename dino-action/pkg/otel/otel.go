...
func InitializeOpenTelemetry(ctx context.Context, cfg OtelConfig) (shutdown func(context.Context) error, outErr error) {
...
func setupTraceProvider(ctx context.Context, cfg TraceConfig) (*sdktrace.TracerProvider, error) {
...
func setupMetricProvider(ctx context.Context, cfg MetricsConfig) (*sdkmetric.MeterProvider, error) {
...
func setupHttpTraceExporter(ctx context.Context, cfg TraceConfig) (sdktrace.SpanExporter, error) {
...
func setupGrpcTraceExporter(ctx context.Context, cfg TraceConfig) (sdktrace.SpanExporter, error) {
...
func setupHttpMetricsExporter(ctx context.Context, cfg MetricsConfig) (sdkmetric.Exporter, error) {
...
func setupGrpcMetricsExporter(ctx context.Context, cfg MetricsConfig) (sdkmetric.Exporter, error) {
